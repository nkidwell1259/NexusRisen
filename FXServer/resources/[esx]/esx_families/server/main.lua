...
ESX.RegisterServerCallback('esx_grovejob:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_grovejob:buy', function(source, cb, amount, weaponName)
